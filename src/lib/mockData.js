...
export const initialMockData = {
    user: {
        ...
        // Assurez-vous que c'est bien default-avatar.jpg et non avatarguest.jpg si c'est le souhait final
        photoURL: '/images/avatars/default-avatar.jpg', // CHEMIN CONFIRMÉ
    },
    tasks: [
    ...
    projects: [
        {
            ...
            // Chemins mis à jour pour correspondre à vos fichiers réels
        ...
        },
        {
            ...
            staff: ['/images/avatars/marcus.jpg'],
            paidAmount: '0 €',
            nextPayment: 'N/A',
            totalAmount: '10 000 €',
            createdAt: getDate(-7),
    ...
    messages: [
        ...
        { id: 'msg2', sender: 'Visiteur Curieux', avatar: '/images/avatars/default-avatar.jpg', text: 'Oui, on a terminé la phase de conception UX hier soir. Prêt pour la revue !', timestamp: '10:05', unread: false, recipient: 'Alice Dubois' },
        ...
        { id: 'msg5', sender: 'Visiteur Curieux', avatar: '/images/avatars/default-avatar.jpg', text: 'Je suis un peu pris, mais je peux regarder ça en fin de journée.', timestamp: 'Hier 14:45', unread: false, recipient: 'Bob Martin' },
        ...
        { id: 'msg8', sender: 'Visiteur Curieux', avatar: '/images/avatars/default-avatar.jpg', text: 'Parfait, je vais le relire dans la matinée.', timestamp: 'Lun. 09:10', unread: false, recipient: 'Charlie Dupont' },
        ...
        { id: 'msg12', sender: 'Visiteur Curieux', avatar: '/images/avatars/default-avatar.jpg', text: 'Super ! Envoie ça quand tu peux. 👍', timestamp: 'Aujourd’hui 11:05', unread: false, recipient: 'Carla Lopez' },
        ...
        { id: 'msg14', sender: 'Visiteur Curieux', avatar: '/images/avatars/default-avatar.jpg', text: 'Wow, ça a l\'air génial ! J\'adore le concept. 🎉', timestamp: 'Aujourd’hui 12:05', unread: false, recipient: 'David Chen' },
    ],
    planningTasks: [
    ...
    staffMembers: [
        ...
        // Fallback pour les membres restants si pas de fichiers spécifiques
        { id: 's8', name: 'Sophie Laurent', role: 'Développeur Frontend', email: 'sophie.l@example.com', avatar: '/images/avatars/default-avatar.jpg' },
        { id: 's9', name: 'Marc Tremblay', role: 'Architecte Cloud', email: 'marc.t@example.com', avatar: '/images/avatars/default-avatar.jpg' },
    ],
    clients: [
...
export const mockPortalData = {
    ...
    author: {
        ...
        avatarUrl: '/images/avatars/yves.jpg', // Chemin confirmé
    },
    isFeatured: true,
    viewCount: '2.5k',
