...
export default function TermsPage() {
  ...
  return (
    <>
      ...
      <div className="bg-color-bg-primary text-color-text-primary min-h-screen flex flex-col items-center justify-center"> {/* Utilise les couleurs du thème */}
        <div className="max-w-4xl mx-auto py-24 px-6 glass-card p-8 rounded-2xl shadow-lg"> {/* Utilise glass-card */}
          <h1 className="text-3xl font-bold mb-4 text-color-text-primary">{pageTitle}</h1>
          <p className="text-color-text-secondary"><strong>{t('lÒast_update', 'Dernière mise à jour :')}</strong> 23 juin 2025</p>

          <h2 className="text-2xl font-semibold mt-8 mb-4 text-color-text-primary">{t('terms_acceptance_title', '1. Acceptation des conditions')}</h2>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-color-text-primary">{t('terms_service_description_title', '2. Description du service')}</h2>
          <p className="text-color-text-secondary">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-color-text-primary">{t('terms_user_accounts_title', '3. Comptes utilisateurs')}</h2>
          <p className="text-color-text-secondary">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-red-500">{t('terms_liability_title', '4. Limitation de responsabilité')}</h2>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-red-500">{t('terms_refund_title', '5. Politique de remboursement')}</h2>
          <p className="border-l-4 border-red-500 pl-4 italic text-color-text-secondary">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-color-text-primary">{t('terms_governing_law_title', '6. Droit applicable')}</h2>
          <p className="text-color-text-secondary">
